...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'arpc.environnement' => 'getArpc_EnvironnementService',
            'arpc.player_csv_import' => 'getArpc_PlayerCsvImportService',
    ...
    /**
     * Gets the 'arpc.environnement' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ARPCCoreBundle\Services\Environnement\ARPCEnvironnement A ARPCCoreBundle\Services\Environnement\ARPCEnvironnement instance.
     */
    protected function getArpc_EnvironnementService()
    {
        return $this->services['arpc.environnement'] = new \ARPCCoreBundle\Services\Environnement\ARPCEnvironnement();
    }

    /**
     * Gets the 'arpc.player_csv_import' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ARPCCoreBundle\Services\Csv\PlayerCsvImport A ARPCCoreBundle\Services\Csv\PlayerCsvImport instance.
     */
    protected function getArpc_PlayerCsvImportService()
    {
        return $this->services['arpc.player_csv_import'] = new \ARPCCoreBundle\Services\Csv\PlayerCsvImport($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'arpc', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\ARPCCoreBundle\\Entity'))), 'ARPCCoreBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('ARPCCoreBundle' => 'ARPCCoreBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_9212076671239d837c5f313efcb5870e14ed5d094885b50cbbed566ba595a359');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\ARPCCoreBundle/Resources/views'), 'ARPCCore');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('07ef2e1ac258b8a31ea34c2ea7dfb704ff6c1c78');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56eef29aaa0217.47574509')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ARPCCoreBundle' => 'ARPCCoreBundle\\ARPCCoreBundle',
            ...
            'secret' => '07ef2e1ac258b8a31ea34c2ea7dfb704ff6c1c78',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '07ef2e1ac258b8a31ea34c2ea7dfb704ff6c1c78',
